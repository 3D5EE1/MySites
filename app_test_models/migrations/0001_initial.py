    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_test_models.Author', verbose_name='автор книги')),
            ],
            options={
                'verbose_name': 'Книга',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('place', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='app_test_models.Place', verbose_name='адрес ресторана')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('restaurant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_test_models.Restaurant', verbose_name='название ресторана')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='article',
            name='publication',
            field=models.ManyToManyField(to='app_test_models.Publication', verbose_name='публикация'),
        ),
    ]
