# Generated by Django 2.1.3 on 2018-11-26 21:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city', models.CharField(choices=[('москва', 'москва'), ('санкт-питербург', 'санкт-питербург'), ('екатеринбург', 'екатеринбург'), ('казань', 'казань')], help_text='Выберите город из списка ', max_length=200, verbose_name='Город')),
            ],
        ),
        migrations.AddField(
            model_name='article',
